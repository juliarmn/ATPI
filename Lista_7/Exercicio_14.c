#include <stdio.h>
/*Faça um programa que receba a hora de início e de término de um jogo. Os valores deverão ser expressos
em quantidade de horas e de minutos, bem como apenas em minutos e apenas em segundos. Considere
que o tempo máximo de duração de um jogo é de 24 horas e que ele pode começar em um dia e terminar
no outro.*/
int main(void) {
  struct tempo {
  ...
  int horaTotal, minutoTotal, segundoTotal, min;
  do {
